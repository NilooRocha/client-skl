...
const Toast = ({ message, type = 'success', visible, onDismiss, duration = 10000 }: ToastProps) => {
  ...
  return (
    <Animated.View
      className={cn(
        `absolute bottom-12 left-5 right-5 rounded-lg px-4 py-3 shadow-lg transition-opacity`,
        background,
        opacity,
        border
      )}
